...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *text = chatData.message;
    
    CGSize size = [text sizeWithFont:[UIFont fontWithName:@"Machinato" size:15] constrainedToSize:CGSizeMake(280, 999) lineBreakMode:NSLineBreakByWordWrapping];
